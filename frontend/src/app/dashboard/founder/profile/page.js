    ...
    <PrivateRoute allowedRoles={['founder']}>
      <motion.div initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }}>
        ...
        <p className="mb-8" style={{ color: 'var(--text-secondary)' }}>
          Update your founder profile information.
        </p>
        ...
        <div className="glass-card rounded-2xl p-8 max-w-2xl">
          <form onSubmit={handleSubmit(onSubmit)} className="space-y-6">
            ...
            <div>
              ...
              <input {...register('skills')} className="input-field" placeholder="Leadership, Strategy, Marketing (comma separated)" />
            </div>

            {/* Bio */}
            <div>
              <label className="block text-sm font-medium mb-2" style={{ color: 'var(--text-primary)' }}>Bio</label>
              <textarea {...register('bio', { maxLength: { value: 500, message: 'Max 500 characters' } })} className="input-field" rows={4} placeholder="Tell us about yourself and your startup vision..." />
